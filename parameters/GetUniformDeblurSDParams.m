...
params.lambda =0.008;    % the regularization parameter of non-local denoiser, i.e. BM3D
params.beta =0.012;      % the regularization parameter of local denoiser, i.e. TNRD

% number of outer iterations
if light_mode
    params.outer_iters = 500;
else
    params.outer_iters = 1000;
end

% level of noise assumed in the local regularization-denoiser
